...
#define OLED_D0_PIN                     (BOARD_DISPLAY_SCL_GPIO_PIN)            // 软件 SPI SCK 引脚
#define OLED_D1_PIN                     (BOARD_DISPLAY_SDA_GPIO_PIN)            // 软件 SPI MOSI 引脚
//====================================================软件 SPI 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
#define OLED_SPI_SPEED                  (30*1000*1000)                          // 硬件 SPI 速率
#define OLED_SPI                        (SPI_2)                                 // 硬件 SPI 号
#define OLED_D0_PIN                     (BOARD_DISPLAY_SCL_SPI_PIN)             // 硬件 SPI SCK 引脚
#define OLED_D1_PIN                     (BOARD_DISPLAY_SDA_SPI_PIN)             // 硬件 SPI MOSI 引脚
#define OLED_D1_PIN_IN                  (BOARD_DISPLAY_MISO_SPI_PIN)            // 硬件 SPI MISO 引脚  OLED没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
//====================================================硬件 SPI 驱动====================================================
#endif


#define OLED_RES_PIN                    (BOARD_DISPLAY_RESET_PIN)               // 液晶复位引脚定义
#define OLED_DC_PIN                     (BOARD_DISPLAY_DC_PIN)                  // 液晶命令位引脚定义
#define OLED_CS_PIN                     (BOARD_DISPLAY_CS_PIN)                  // CS 片选引脚
