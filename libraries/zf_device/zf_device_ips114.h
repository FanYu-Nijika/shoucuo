...
#define IPS114_SCL_PIN                  (BOARD_DISPLAY_SCL_GPIO_PIN)            // 软件 SPI SCK 引脚
#define IPS114_SDA_PIN                  (BOARD_DISPLAY_SDA_GPIO_PIN)            // 软件 SPI MOSI 引脚
//====================================================软件 SPI 驱动==================================================
#else
//====================================================硬件 SPI 驱动==================================================
#define IPS114_SPI_SPEED                (60*1000*1000)                          // 硬件 SPI 速率
#define IPS114_SPI                      (SPI_2)                                 // 硬件 SPI 号
#define IPS114_SCL_PIN                  (BOARD_DISPLAY_SCL_SPI_PIN)             // 硬件 SPI SCK 引脚
#define IPS114_SDA_PIN                  (BOARD_DISPLAY_SDA_SPI_PIN)             // 硬件 SPI MOSI 引脚
#define IPS114_SDA_IN_PIN               (BOARD_DISPLAY_MISO_SPI_PIN)            // 定义SPI_MISO引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
//====================================================硬件 SPI 驱动==================================================
#endif

#define IPS114_RST_PIN                  (BOARD_DISPLAY_RESET_PIN)                // 液晶复位引脚定义
#define IPS114_DC_PIN                   (BOARD_DISPLAY_DC_PIN)                   // 液晶命令位引脚定义
#define IPS114_CS_PIN                   (BOARD_DISPLAY_CS_PIN)                   // CS 片选引脚
#define IPS114_BLK_PIN                  (BOARD_DISPLAY_BACKLIGHT_PIN)            // 液晶背光引脚定义
