...
//==================================================定义 IPS200 基本配置================================================
#define IPS200_USE_SOFT_SPI             (1 )                                    // 默认使用硬件 SPI 方式驱动 建议使用硬件 SPI 方式驱动
...
#define IPS200_SCL_PIN                  (BOARD_DISPLAY_SCL_GPIO_PIN)            // 软件 SPI SCK 引脚
#define IPS200_SDA_PIN                  (BOARD_DISPLAY_SDA_GPIO_PIN)            // 软件 SPI MOSI 引脚
//====================================================软件 SPI 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
// 如果使用的是SPI 串口的两寸屏幕 SPI 驱动控制引脚 可以修改
...
#define IPS200_SCL_PIN_SPI              (BOARD_DISPLAY_SCL_SPI_PIN)             // 硬件 SPI SCK 引脚
#define IPS200_SDA_PIN_SPI              (BOARD_DISPLAY_SDA_SPI_PIN)             // 硬件 SPI MOSI 引脚
#define IPS200_SDA_IN_PIN_SPI           (BOARD_DISPLAY_MISO_SPI_PIN)            // 硬件 SPI MISO 引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
//====================================================硬件 SPI 驱动====================================================
#endif
// 如果使用的是SPI 串口的两寸屏幕 SPI 驱动控制引脚 可以修改
#define IPS200_RST_PIN_SPI              (BOARD_DISPLAY_RESET_PIN)               // (SPI串口)液晶复位引脚定义
#define IPS200_DC_PIN_SPI               (BOARD_DISPLAY_DC_PIN)                  // (SPI串口)液晶命令位引脚定义
#define IPS200_CS_PIN_SPI               (BOARD_DISPLAY_CS_PIN)                  // (SPI串口)液晶片选引脚定义
#define IPS200_BLk_PIN_SPI              (BOARD_DISPLAY_BACKLIGHT_PIN)           // (SPI串口)液晶背光引脚定义
