...
#define IPS200PRO_CLK_PIN                  	    (BOARD_DISPLAY_SCL_SPI_PIN)    // 硬件 SPI SCK 引脚
#define IPS200PRO_MOSI_PIN                 	    (BOARD_DISPLAY_SDA_SPI_PIN)    // 硬件 SPI MOSI 引脚
#define IPS200PRO_MISO_PIN                 	    (BOARD_DISPLAY_MISO_SPI_PIN)   // 硬件 SPI MISO 引脚  TFT没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
#define IPS200PRO_RST_PIN                  	    (BOARD_DISPLAY_RESET_PIN)      // 液晶复位引脚定义
#define IPS200PRO_INT_PIN                  	    (BOARD_DISPLAY_DC_PIN)         // 液晶命令位引脚定义
#define IPS200PRO_CS_PIN                   	    (BOARD_DISPLAY_CS_PIN)         // CS 片选引脚
