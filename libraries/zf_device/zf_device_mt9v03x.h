...
#undef MT9V03X_COF_UART_TX
#undef MT9V03X_COF_UART_RX
#undef MT9V03X_COF_IIC_SCL
#undef MT9V03X_COF_IIC_SDA
#undef MT9V03X_PCLK_PIN
#undef MT9V03X_VSYNC_PIN
#undef MT9V03X_DATA_PIN
#define MT9V03X_COF_UART_TX     (BOARD_CAMERA_CONFIG_UART_TX_PIN)
#define MT9V03X_COF_UART_RX     (BOARD_CAMERA_CONFIG_UART_RX_PIN)
#define MT9V03X_COF_IIC_SCL     (BOARD_CAMERA_CONFIG_SCL_PIN)
#define MT9V03X_COF_IIC_SDA     (BOARD_CAMERA_CONFIG_SDA_PIN)
#define MT9V03X_PCLK_PIN        (BOARD_CAMERA_PCLK_PIN)
#define MT9V03X_VSYNC_PIN       (BOARD_CAMERA_VSYNC_PIN)
#define MT9V03X_DATA_PIN        (BOARD_CAMERA_DATA_PIN)
...
#define MT9V03X_UD_OFFSET_DEF   ( 0   )                                         // 图像上下偏移量   正值 上偏移   负值 下偏移  行为120 240 480时无法设置偏移
                                                                                //                  摄像头收偏移数据后会自动计算最大偏移，如果超出则设置计算出来的最大偏移
#define MT9V03X_GAIN_DEF        ( 4  )                                         // 图像增益         范围 [16-64]  增益可以在曝光时间固定的情况下改变图像亮暗程度
