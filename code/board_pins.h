...
#define BOARD_LEFT_MOTOR_FORWARD_PWM_PIN   (BOARD_SERVO1_PWM_PIN)
#define BOARD_LEFT_MOTOR_REVERSE_PWM_PIN   (BOARD_SERVO2_PWM_PIN)
#define BOARD_RIGHT_MOTOR_FORWARD_PWM_PIN  (BOARD_SERVO3_PWM_PIN)
#define BOARD_RIGHT_MOTOR_REVERSE_PWM_PIN  (BOARD_SERVO4_PWM_PIN)
